...
import { isPDF as isPDFValidation, isZIP as isZIPValidation } from './fileValidation.js'
 ...
 * Re-exported from fileValidation.js for backward compatibility
 * @param {Buffer|ArrayBuffer} data - File data
 * @returns {boolean}
 */
export function isPDF(data) {
  return isPDFValidation(data)
}

/**
 * Check if a file is a valid ZIP
 * Re-exported from fileValidation.js
 * @param {Buffer|ArrayBuffer} data - File data
 * @returns {boolean}
 */
export function isZIP(data) {
  return isZIPValidation(data)
}
