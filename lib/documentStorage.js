/**
 * Document Storage Service - Supabase Storage
 * 
 * Handles storage and retrieval of user documents (statements, notices, etc.)
 * Migrated from Netlify Blobs to Supabase Storage
 */

// Supabase migration: Documents now stored in Supabase Storage bucket 'documents'
// @netlify/blobs is no longer used
// Use supabaseStorage.js instead
const useBlobs = false

function getDocumentStore() {
  // Legacy function - no longer used after Supabase migration
  throw new Error('getDocumentStore is deprecated. Use supabaseStorage.js instead')
}
