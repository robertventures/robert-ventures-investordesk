 ...
 * 
 * Handles storage and retrieval of user documents (tax forms, statements, etc.)
 */
 ...
 * @param {string} key - The blob key (e.g., 'tax-documents/2024/USR-1001.pdf')
 ...
 * @param {string} prefix - The prefix to filter by (e.g., 'tax-documents/2024/')
 ...
 * @param {string} type - Document type (e.g., 'tax-documents', 'statements')
