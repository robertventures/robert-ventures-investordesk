 ...
 * Allows switching between local Next.js routes and Python backend
 */

// Get API base URL from environment variable
const API_BASE_URL = process.env.NEXT_PUBLIC_API_URL || ''

// If NEXT_PUBLIC_API_URL is empty, use relative paths (local Next.js routes)
// If set (e.g., 'http://localhost:8000'), use absolute URLs
...
class ApiClient {
   ...
   */
  buildUrl(endpoint) {
    // If baseUrl is empty, return relative path (for local Next.js)
